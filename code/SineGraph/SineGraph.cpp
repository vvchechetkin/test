...
// SineGraph.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSineGraphApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CSineGraphApp

CSineGraphApp::CSineGraphApp()
{
...
// Единственный объект CSineGraphApp

CSineGraphApp theApp;


// инициализация CSineGraphApp

BOOL CSineGraphApp::InitInstance()
{
